...
class ChiTietDonThuocDAO {
  static async getChiTietByMaDonThuoc(donThuocId) {
    ...
    return items.map(i => ({ id: i.id, soLuong: i.soLuong, donGia: i.donGia, thuoc: i.Thuoc ? { maThuoc: i.Thuoc.maThuoc, ten: i.Thuoc.ten, tonKho: i.Thuoc.tonKho, coBH: i.Thuoc.coBH } : null }));
  }
}
